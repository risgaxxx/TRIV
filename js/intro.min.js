...
!(function (t, e) {
  ...
  var l = function (t) {
    ...
    C = a.document,
    E = w(C) && w(C.createElement),
    A = function (t) {
      return E ? C.createElement(t) : {};
    },
    k =
      !c &&
      !s(function () {
    ...
    N = {
      f: c
        ...
        : function (t, e) {
            ...
            if (j(t, e)) return p(!f.f.call(t, e), t[e]);
          },
    },
    I = function (t) {
  ...
  var H,
    ...
    U = B.inspectSource,
    F = a.WeakMap,
    z = "function" == typeof F && /native code/.test(U(F)),
    W = r(function (t) {
    ...
    J = {},
    Q = "Object already initialized",
    Z = a.WeakMap;
  if (z || B.state) {
    var tt = B.state || (B.state = new Z()),
      et = tt.get,
      nt = tt.has,
      it = tt.set;
    (H = function (t, e) {
      if (nt.call(tt, t)) throw new TypeError(Q);
      return (e.facade = t), it.call(tt, t, e), e;
    }),
      (D = function (t) {
        return et.call(tt, t) || {};
      }),
    ...
    (J[ot] = !0),
      (H = function (t, e) {
        if (j(t, ot)) throw new TypeError(Q);
        return (e.facade = t), L(t, ot, e), e;
      }),
      (D = function (t) {
        return j(t, ot) ? t[ot] : {};
      }),
  ...
  var rt = {
    ...
    lt = r(function (t) {
      ...
      (t.exports = function (t, e, o, r) {
        var l,
          ...
          u = !!r && !!r.noTargetGet;
        "function" == typeof o &&
          ("string" != typeof e || j(o, "name") || L(o, "name", e),
          (l = n(o)).source ||
    ...
    ct = function (t, e) {
      return arguments.length < 2
        ? st(at[t]) || st(a[t])
        : (at[t] && at[t][e]) || (a[t] && a[t][e]);
    },
    ut = Math.ceil,
    ht = Math.floor,
    ft = function (t) {
      return isNaN((t = +t)) ? 0 : (t > 0 ? ht : ut)(t);
    },
    pt = Math.min,
    dt = function (t) {
      return t > 0 ? pt(ft(t), 9007199254740991) : 0;
    },
    gt = Math.max,
    vt = Math.min,
    mt = function (t, e) {
      var n = ft(t);
      return n < 0 ? gt(n + e, 0) : vt(n, e);
    },
    bt = function (t) {
    ...
    _t = function (t, e) {
      var n,
        ...
        o = 0,
        r = [];
      for (n in i) !j(J, n) && j(i, n) && r.push(n);
      for (; e.length > o; ) j(i, (n = e[o++])) && (~wt(r, n) || r.push(n));
      return r;
    },
    St = [
      "constructor",
    ...
    At = function (t, e) {
      for (var n = Et(e), i = O.f, o = N.f, r = 0; r < n.length; r++) {
        var l = n[r];
        j(t, l) || i(t, l, o(e, l));
      }
    },
    ...
    Tt = function (t, e) {
      var n = It[Nt(t)];
      return n == Ot || (n != Pt && ("function" == typeof e ? s(e) : !!e));
    },
    Nt = (Tt.normalize = function (t) {
    ...
    qt = function (t, e) {
      var n,
        ...
        c = t.global,
        u = t.stat;
      if ((n = c ? a : u ? a[s] || R(s, {}) : (a[s] || {}).prototype))
        for (i in e) {
          if (
            ((r = e[i]),
            (o = t.noTargetGet ? (l = Rt(n, i)) && l.value : n[i]),
            !Lt(c ? i : s + (u ? "." : "#") + i, t.forced) && void 0 !== o)
          ) {
            if (typeof r == typeof o) continue;
            At(r, o);
          }
          (t.sham || (o && o.sham)) && L(r, "sham", !0), lt(n, i, r, t);
        }
    },
    Bt = function () {
      var t = I(this),
  ...
  var Ht,
    ...
    Ft = W("native-string-replace", String.prototype.replace),
    zt = Ut,
    Wt =
      ((Ht = /a/),
      (Dt = /b*/g),
      Ut.call(Ht, "a"),
      Ut.call(Dt, "a"),
      0 !== Ht.lastIndex || 0 !== Dt.lastIndex),
    Gt = $t.UNSUPPORTED_Y || $t.BROKEN_CARET,
    Vt = void 0 !== /()??/.exec("")[1];
  (Wt || Vt || Gt) &&
    (zt = function (t) {
      var e,
      ...
      return (
        ...
        l
          ? i
            ...
            : (r.lastIndex = 0)
          : Wt && i && (r.lastIndex = r.global ? i.index + i[0].length : e),
        Vt &&
          i &&
          i.length > 1 &&
          Ft.call(i[0], n, function () {
  ...
  var Kt = zt;
  qt({ target: "RegExp", proto: !0, forced: /./.exec !== Kt }, { exec: Kt });
  var Yt,
    Xt,
    Jt = ct("navigator", "userAgent") || "",
    Qt = a.process,
    Zt = Qt && Qt.versions,
    te = Zt && Zt.v8;
  te
    ? (Xt = (Yt = te.split("."))[0] < 4 ? 1 : Yt[0] + Yt[1])
    : Jt &&
      (!(Yt = Jt.match(/Edge\/(\d+)/)) || Yt[1] >= 74) &&
      (Yt = Jt.match(/Chrome\/(\d+)/)) &&
      (Xt = Yt[1]);
  var ee = Xt && +Xt,
    ne =
    ...
    ie = ne && !Symbol.sham && "symbol" == typeof Symbol.iterator,
    oe = W("wks"),
    re = a.Symbol,
    le = ie ? re : (re && re.withoutSetter) || K,
    ae = function (t) {
      return (
        (j(oe, t) && (ne || "string" == typeof oe[t])) ||
          (ne && j(re, t) ? (oe[t] = re[t]) : (oe[t] = le("Symbol." + t))),
        oe[t]
      );
    },
    se = ae("species"),
      ...
      if (
        ...
        var a = /./[o],
          c = n(
            ...
            {
              REPLACE_KEEPS_$0: he,
              REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: pe,
            }
          ),
          u = c[0],
          h = c[1];
        lt(String.prototype, t, u),
          lt(
            ce,
            o,
            2 == e
    ...
    me = { codeAt: ve(!1), charAt: ve(!0) }.charAt,
    be = function (t, e, n) {
      return e + (n ? me(t, e).length : 1);
    },
    ye = function (t, e) {
      var n = t.exec;
  ...
  ge("match", 1, function (t, e, n) {
    return [
      ...
      function (t) {
        ...
        var o = I(t),
          r = String(this);
        if (!o.global) return ye(o, r);
        var l = o.unicode;
        o.lastIndex = 0;
        for (var a, s = [], c = 0; null !== (a = ye(o, r)); ) {
          var u = String(a[0]);
          (s[c] = u),
            "" === u && (o.lastIndex = be(r, dt(o.lastIndex), l)),
            c++;
        }
        return 0 === c ? null : s;
      },
  ...
  var we =
    ...
    xe = function (t, e) {
      ...
      return (
        we(t) &&
          ...
          (n !== Array && !we(n.prototype))
            ? w(n) && null === (n = n[Se]) && (n = void 0)
            : (n = void 0)),
    ...
    Ee = ae("isConcatSpreadable"),
    Ae = 9007199254740991,
    ke = "Maximum allowed index exceeded",
    Te =
      ee >= 51 ||
      !s(function () {
        var t = [];
  ...
  qt(
    { target: "Array", proto: !0, forced: !Te || !Ne },
    {
      concat: function (t) {
        var e,
          n,
        ...
        for (e = -1, i = arguments.length; e < i; e++)
          if (Ie((r = -1 === e ? l : arguments[e]))) {
            if (s + (o = dt(r.length)) > Ae) throw TypeError(ke);
            for (n = 0; n < o; n++, s++) n in r && _e(a, s, r[n]);
          } else {
            if (s >= Ae) throw TypeError(ke);
            _e(a, s++, r);
          }
        return (a.length = s), a;
      },
  ...
  Oe || lt(Object.prototype, "toString", Be, { unsafe: !0 });
  var Me = "toString",
    He = RegExp.prototype,
    De = He.toString,
    $e = s(function () {
    ...
    lt(
      ...
      function () {
        ...
        return (
          ...
          "/" +
          String(
            void 0 === n && t instanceof RegExp && !("flags" in He)
              ? Bt.call(t)
              : n
          )
        );
  ...
  var Fe = ae("match"),
    ze = function (t) {
      var e;
      return w(t) && (void 0 !== (e = t[Fe]) ? !!e : "RegExp" == g(t));
    },
    We = function (t) {
          ...
          function (t, o) {
            ...
            var l = I(t),
              ...
              s = (function (t, e) {
                var n,
                  i = I(t).constructor;
                return void 0 === i || null == (n = I(i)[Ge]) ? e : We(n);
              })(l, RegExp),
              c = l.unicode,
              u =
                (l.ignoreCase ? "i" : "") +
                ...
                (l.unicode ? "u" : "") +
                (Ve ? "g" : "y"),
              h = new s(Ve ? "^(?:" + l.source + ")" : l, u),
              f = void 0 === o ? Xe : o >>> 0;
            if (0 === f) return [];
            if (0 === a.length) return null === ye(h, a) ? [a] : [];
            for (var p = 0, d = 0, g = []; d < a.length; ) {
              h.lastIndex = Ve ? 0 : d;
              var v,
                m = ye(h, Ve ? a.slice(d) : a);
              if (
                null === m ||
                (v = Ye(dt(h.lastIndex + (Ve ? d : 0)), a.length)) === p
              )
                d = be(a, d, c);
              else {
                if ((g.push(a.slice(p, d)), g.length === f)) return g;
                for (var b = 1; b <= m.length - 1; b++)
                  if ((g.push(m[b]), g.length === f)) return g;
                d = p = v;
              }
            }
    ...
    an =
      ...
      s(function () {
            ...
            rn(
              ...
              rn(
                ln({}, "a", {
                  enumerable: !0,
                  get: function () {
                    ln(this, "b", { value: 3, enumerable: !1 });
                  },
                }),
                { b: 2 }
              )
        ...
        return (
          ...
          7 != rn({}, t)[n] || on(rn({}, e)).join("") != i
        );
      })
        ? function (t, e) {
            for (
              var n = S(t), i = arguments.length, o = 1, r = Ct.f, l = f.f;
              i > o;
  ...
  function cn(t) {
    var e = t.parentNode;
    return (
      !(!e || "HTML" === e.nodeName) && ("fixed" === Qe(t, "position") || cn(e))
    );
  }
  qt(
    { target: "Object", stat: !0, forced: Object.assign !== an },
    { assign: an }
  );
  var un = Math.floor,
    hn = "".replace,
    fn = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
    pn = /\$([$&'`]|\d{1,2})/g,
    dn = function (t, e, n, i, o, r) {
      var l = n + t.length,
        a = i.length,
        s = pn;
      return (
        void 0 !== o && ((o = S(o)), (s = fn)),
        hn.call(r, s, function (r, s) {
          var c;
          switch (s.charAt(0)) {
            case "$":
              return "$";
  ...
  function yn(t) {
    if (t) {
      ...
      var e = this._introItems[this._currentStep],
        n = sn(e.element, this._targetElement),
        i = this._options.helperElementPadding;
      cn(e.element)
        ? Je(t, "introjs-fixedTooltip")
        : mn(t, "introjs-fixedTooltip"),
    ...
    return [
      ...
      function (t, i) {
        ...
        for (var p = []; ; ) {
          ...
          if (null === d) break;
          if ((p.push(d), !h)) break;
          "" === String(d[0]) && (s.lastIndex = be(c, dt(s.lastIndex), f));
        }
        for (var g, v = "", m = 0, b = 0; b < p.length; b++) {
          d = p[b];
          for (
            var y = String(d[0]),
              w = gn(vn(ft(d.index), c.length), 0),
              _ = [],
              S = 1;
            S < d.length;
            S++
          ...
          } else C = dn(y, c, w, _, x, i);
          w >= m && ((v += c.slice(m, w) + C), (m = w + y.length));
        }
        return v + c.slice(m);
      },
    ];
  ...
  var wn,
    _n = c
      ...
      : function (t, e) {
          I(t);
          for (var n, i = on(e), o = i.length, r = 0; o > r; )
            O.f(t, (n = i[r++]), e[n]);
          return t;
        },
    Sn = ct("document", "documentElement"),
    xn = X("IE_PROTO"),
    jn = function () {},
    Cn = function (t) {
    ...
    En = function () {
      ...
      En = wn
        ...
        : (((e = A("iframe")).style.display = "none"),
          ...
          t.write(Cn("document.F=Object")),
          t.close(),
          t.F);
      for (var n = St.length; n--; ) delete En.prototype[St[n]];
      return En();
    };
  J[xn] = !0;
  var An =
    ...
    kn = ae("unscopables"),
    Tn = Array.prototype;
  null == Tn[kn] && O.f(Tn, kn, { configurable: !0, value: An(null) });
  var Nn,
    In = yt.includes;
  qt(
  ...
  var Mn = function (t, e) {
    ...
    $n = Mn("join", ",");
  qt(
    { target: "Array", proto: !0, forced: Dn || !$n },
    {
      join: function (t) {
        return Hn.call(y(this), void 0 === t ? "," : t);
      },
    }
  );
  var Un = [].push,
  ...
  qt(
    { target: "Array", proto: !0, forced: !Ce("filter") },
    {
      filter: function (t) {
  ...
  var Vn = Ce("splice"),
    ...
    Yn = Math.min,
    Xn = 9007199254740991,
    Jn = "Maximum allowed length exceeded";
  function Qn(t, e) {
  ...
  function Zn(t, e, n) {
    var i = this._options.positionPrecedence.slice(),
      ...
      s = "floating";
    a.bottom + r > o.height && Qn(i, "bottom"),
      a.top - r < 0 && Qn(i, "top"),
      a.right + l > o.width && Qn(i, "right"),
      a.left - l < 0 && Qn(i, "left");
    var c,
      u,
    ...
    return (
      ...
      ["top", "bottom"].includes(s) &&
        (s += (function (t, e, n, i) {
          ...
          return (
            l - t < e && Qn(a, "-left-aligned"),
            (t < r || l - t < r) && Qn(a, "-middle-aligned"),
            t < e && Qn(a, "-right-aligned"),
    ...
    if (
      ...
      switch (
        ...
        "floating" !== (s = this._introItems[this._currentStep].position) &&
          ...
          (s = Zn.call(this, t, e, s)),
        (l = sn(t)),
        (r = sn(e)),
        (a = tn()),
        Je(e, "introjs-".concat(s)),
        s)
      ) {
        case "top-right-aligned":
          n.className = "introjs-arrow bottom-right";
          var u = 0;
          Gn(l, u, r, e), (e.style.bottom = "".concat(l.height + 20, "px"));
          break;
        case "top-middle-aligned":
          n.className = "introjs-arrow bottom-middle";
          var h = l.width / 2 - r.width / 2;
          i && (h += 5),
            Gn(l, h, r, e) && ((e.style.right = null), Wn(l, h, r, a, e)),
  ...
  function ni(t, e) {
    ...
    for (var o in e) {
      var r = e[o];
      "style" === o ? bn(n, r) : o.match(i) ? n.setAttribute(o, r) : (n[o] = r);
    }
    return n;
  }
  function ii(t, e, n) {
  ...
  function ri() {
    ...
    null === t &&
      ((t = ni("div", { className: "introjs-disableInteraction" })),
      this._targetElement.appendChild(t)),
      yn.call(this, t);
  }
  function li(t) {
    var e = this,
      i = ni("div", { className: "introjs-bullets" });
  ...
  function ai(t, e) {
    if (this._options.showBullets) {
      ...
      n.parentNode.replaceChild(li.call(this, e), n);
    }
  }
  function si(t, e) {
  ...
  function ci() {
    ...
    var e = ni("div", { className: "introjs-progressbar" });
    return (
      ...
      e.setAttribute("aria-valuenow", oi.call(this)),
      (e.style.cssText = "width:".concat(oi.call(this), "%;")),
      t.appendChild(e),
      t
    );
  }
  function ui(t) {
    (t.querySelector(".introjs-progress .introjs-progressbar").style.cssText =
      "width:".concat(oi.call(this), "%;")),
      t
        .querySelector(".introjs-progress .introjs-progressbar")
        .setAttribute("aria-valuenow", oi.call(this));
  }
  function hi(t) {
    var e = this;
        ...
        (r._lastShowElementTimer = window.setTimeout(function () {
          null !== c &&
            ...
            ((null != n && /introjs-donebutton/gi.test(n.className)) ||
              null != n) &&
              n.focus(),
            en.call(r, t.scrollTo, t, u);
        }, 350));
    } else {
      var d = ni("div", { className: s }),
        g = ni("div", { className: "introjs-tooltipReferenceLayer" }),
        v = ni("div", { className: "introjs-arrow" }),
        m = ni("div", { className: "introjs-tooltip" }),
        b = ni("div", { className: "introjs-tooltiptext" }),
        y = ni("div", { className: "introjs-tooltip-header" }),
        w = ni("h1", { className: "introjs-tooltip-title" }),
        _ = ni("div");
      bn(d, {
        "box-shadow":
        ...
        yn.call(r, d),
        yn.call(r, g),
        ii(this._targetElement, d, !0),
        ii(this._targetElement, g),
        (b.innerHTML = t.intro),
        (w.innerHTML = t.title),
        ...
        m.appendChild(y),
        m.appendChild(b),
        m.appendChild(li.call(this, t)),
        m.appendChild(ci.call(this));
      var S = ni("div");
      !0 === this._options.showStepNumbers &&
        ((S.className = "introjs-helperNumberLayer"),
        (S.innerHTML = ""
          .concat(t.step, " of ")
        ...
        ((n = ni("a")).onclick = function () {
          r._introItems.length - 1 !== r._currentStep
            ...
            : /introjs-donebutton/gi.test(n.className) &&
              ...
              Qi.call(r, r._targetElement));
        }),
        nn(n),
        (n.innerHTML = this._options.nextLabel),
        ((i = ni("a")).onclick = function () {
          0 !== r._currentStep && gi.call(r);
        }),
        nn(i),
        (i.innerHTML = this._options.prevLabel),
        nn((o = ni("a", { className: "introjs-skipbutton" }))),
        ...
        _.appendChild(n),
        m.appendChild(_),
        ti.call(r, t.element, m, v),
        en.call(this, t.scrollTo, t, m);
    }
    var x = r._targetElement.querySelector(".introjs-disableInteraction");
    x && x.parentNode.removeChild(x),
      t.disableInteraction && ri.call(r),
        ...
        ? (null != n &&
          ...
          !0 === this._options.hidePrev
            ? (null != i &&
              ...
              null != n && Je(n, "introjs-fullbutton"))
            : null != i &&
              (i.className = "".concat(
                this._options.buttonClass,
        ...
        ? (null != i &&
          ...
          !0 === this._options.hideNext
            ? (null != n &&
              ...
              null != i && Je(i, "introjs-fullbutton"))
            : null != n &&
      ...
      (function (t) {
        var e = t.element;
        Je(e, "introjs-showElement");
        var n = Qe(e, "position");
        "absolute" !== n &&
          "relative" !== n &&
          "sticky" !== n &&
          "fixed" !== n &&
          Je(e, "introjs-relativePosition");
      })(t),
      void 0 !== this._introAfterChangeCallback &&
        this._introAfterChangeCallback.call(this, t.element);
  }
  function fi(t) {
    (this._currentStep = t - 2), void 0 !== this._introItems && di.call(this);
  }
  function pi(t) {
    (this._currentStepNumber = t), void 0 !== this._introItems && di.call(this);
  }
  function di() {
    var t = this;
    ...
    return (
      ...
      !1 === i
        ...
        ? ("function" == typeof this._introCompleteCallback &&
          ...
          void Qi.call(this, this._targetElement))
        : void hi.call(this, e)
    );
  }
  function gi() {
  ...
  function mi(t) {
    ...
    if (
      ...
      if ("ArrowLeft" === e || 37 === e) gi.call(this);
      else if ("ArrowRight" === e || 39 === e) di.call(this);
    ...
    } else Qi.call(this, this._targetElement);
  }
  function bi(e) {
  ...
  function wi(t) {
    var e = yi('.introjs-hint[data-step="'.concat(t, '"]'))[0];
    Ti.call(this),
      e && Je(e, "introjs-hidehint"),
      void 0 !== this._hintCloseCallback &&
        this._hintCloseCallback.call(this, t);
  }
  function _i() {
    var t = this;
    n(yi(".introjs-hint"), function (e) {
  ...
  function Si() {
    ...
    e && e.length
      ? n(e, function (e) {
          xi.call(t, e.getAttribute("data-step"));
        })
      : Ni.call(this, this._targetElement);
  }
  function xi(t) {
    var e = yi('.introjs-hint[data-step="'.concat(t, '"]'))[0];
    e && mn(e, /introjs-hidehint/g);
  }
  function ji() {
    var t = this;
    n(yi(".introjs-hint"), function (e) {
      Ci.call(t, e.getAttribute("data-step"));
    });
  }
  function Ci(t) {
    var e = yi('.introjs-hint[data-step="'.concat(t, '"]'))[0];
    ...
    n(this._introItems, function (n, o) {
      if (
        ...
        nn(r),
          ...
          n.hintAnimation || Je(r, "introjs-hint-no-anim"),
          cn(n.element) && Je(r, "introjs-fixedhint");
        var l = ni("div", { className: "introjs-hint-dot" }),
          a = ni("div", { className: "introjs-hint-pulse" });
        r.appendChild(l),
          r.appendChild(a),
          r.setAttribute("data-step", o),
          (n.targetElement = n.element),
          (n.element = r),
          Ai.call(t, n.hintPosition, r, n.targetElement),
          i.appendChild(r);
      }
    }),
    ...
    switch (t) {
      ...
      case "bottom-left":
        (i.left = "".concat(o.left, "px")),
          (i.top = "".concat(o.top + o.height - l, "px"));
        break;
      case "bottom-right":
        (i.left = "".concat(o.left + o.width - r, "px")),
          (i.top = "".concat(o.top + o.height - l, "px"));
      ...
      case "middle-left":
        (i.left = "".concat(o.left, "px")),
          (i.top = "".concat(o.top + (o.height - l) / 2, "px"));
        break;
      case "middle-right":
        (i.left = "".concat(o.left + o.width - r, "px")),
          (i.top = "".concat(o.top + (o.height - l) / 2, "px"));
  ...
  function ki(t) {
    ...
    var i = Ti.call(this);
    if (parseInt(i, 10) !== t) {
      var o = ni("div", { className: "introjs-tooltip" }),
        r = ni("div"),
        l = ni("div"),
        a = ni("div");
  ...
  function Ni(t) {
    ...
    Ei.call(this),
      i.on(document, "click", Ti, this, !1),
      i.on(window, "resize", Ii, this, !0);
  }
  function Ii() {
    var t = this;
      ...
      splice: function (t, e) {
        ...
        if (
          (0 === h
            ...
            : 1 === h
            ? ((n = 0), (i = c - u))
            : ((n = h - 2), (i = Yn(Kn(ft(e), 0), c - u))),
          c + n - i > Xn)
        )
          throw TypeError(Jn);
        for (o = xe(s, i), r = 0; r < i; r++)
          (l = u + r) in s && _e(o, r, s[l]);
        if (((o.length = i), n < i)) {
          for (r = u; r < c - i; r++)
  ...
  var Pi = Math.floor,
    Oi = function (t, e) {
      var n = t.length,
        i = Pi(n / 2);
      return n < 8 ? Li(t, e) : Ri(Oi(t.slice(0, i), e), Oi(t.slice(i), e), e);
    },
    Li = function (t, e) {
    ...
    Ri = function (t, e, n) {
      for (
        var i = t.length, o = e.length, r = 0, l = 0, a = [];
        r < i || l < o;

      )
        r < i && l < o
          ? a.push(n(t[r], e[l]) <= 0 ? t[r++] : e[l++])
          : a.push(r < i ? t[r++] : e[l++]);
      return a;
    },
    qi = Oi,
    Bi = Jt.match(/firefox\/(\d+)/i),
    Mi = !!Bi && +Bi[1],
    Hi = /MSIE|Trident/.test(Jt),
    Di = Jt.match(/AppleWebKit\/(\d+)\./),
    $i = !!Di && +Di[1],
    Ui = [],
    Fi = Ui.sort,
    zi = s(function () {
    ...
    Vi = !s(function () {
      ...
      if (!(Mi && Mi > 3)) {
        ...
        for (t = 65; t < 76; t++) {
          ...
          for (i = 0; i < 47; i++) Ui.push({ k: e + i, v: n });
        }
        for (
          Ui.sort(function (t, e) {
            return e.v - t.v;
          }),
            i = 0;
          i < Ui.length;
          ...
          (e = Ui[i].k.charAt(0)), o.charAt(o.length - 1) !== e && (o += e);
    ...
    if (this._options.steps)
      n(this._options.steps, function (t) {
        ...
        if (
          ...
          null === i &&
            ((i = ni("div", { className: "introjsFloatingElement" })),
            document.body.appendChild(i)),
            (n.element = i),
            (n.position = "floating");
        }
  ...
  function Yi(t) {
    ...
    if (
      ...
      yn.call(this, i),
      t &&
        ((this._introItems = Ki.call(this, this._targetElement)),
        ai.call(this, e, this._introItems[this._currentStep]),
        ui.call(this, e)),
      ...
      ti.call(this, this._introItems[this._currentStep].element, r, o);
    }
  ...
  function Qi(t, e) {
    ...
    if (
      ...
      r &&
        ...
        Ji(t.querySelector(".introjs-helperLayer"), !0),
        Ji(t.querySelector(".introjs-tooltipReferenceLayer")),
        Ji(t.querySelector(".introjs-disableInteraction")),
        Ji(document.querySelector(".introjsFloatingElement")),
        ei(),
        i.off(window, "keydown", mi, this, !0),
        i.off(window, "resize", Xi, this, !0),
  ...
  function Zi(t) {
    var e = this,
      n = ni("div", { className: "introjs-overlay" });
    return (
      bn(n, { top: 0, bottom: 0, left: 0, right: 0, position: "fixed" }),
      t.appendChild(n),
      ...
      0 === e.length ||
        ...
        Zi.call(this, t) &&
          ...
          this._options.keyboardNavigation &&
            i.on(window, "keydown", mi, this, !0),
          i.on(window, "resize", Xi, this, !0))),
      !1
    );
  }
  qt(
    { target: "Array", proto: !0, forced: zi || !Wi || !Gi || !Vi },
    {
      sort: function (t) {
        void 0 !== t && We(t);
        var e = S(this);
        if (Vi) return void 0 === t ? Fi.call(e) : Fi.call(e, t);
        var n,
          i,
          o = [],
          r = dt(e.length);
    ...
    (no.fn = eo.prototype =
      {
        ...
        nextStep: function () {
          return di.call(this), this;
        },
        previousStep: function () {
          return gi.call(this), this;
        },
        currentStep: function () {
          return vi.call(this);
        },
        exit: function (t) {
          return Qi.call(this, this._targetElement, t), this;
        },
        refresh: function (t) {
        ...
        addHints: function () {
          return Ni.call(this, this._targetElement), this;
        },
        hideHint: function (t) {
